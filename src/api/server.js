...
export function createServer() {
  ...
  // Body parsers. 5mb for both — the /accounts and /champions CSV paste
  // endpoints can legitimately carry a few thousand rows, and the default
  // 100kb on urlencoded silently rejects them with "PayloadTooLargeError".
